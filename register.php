        ...
        <div class="card reg-form col-md-5 border-0 bg-danger form-main mb-5">
            <div class="forms pb-3 pl-5 pr-5">
                ...
                <form method="post" action="route/route.php">
                    ...
                    <div class="form-group">
                        <input id="pnumber" class="form-control" type="tel" name="pnumber" placeholder="Phone number" required>
                    </div>
                    <div class="form-group">
                        <input id="email" class="form-control" type="email" name="email" placeholder="email" required>
                    </div>
                    <div class="form-group">
                        <label for="region" class="text-light">Region</label>
                    ...
                    <div class="form-group">
                        <label for="blood" class="text-light">Blood Type</label>
                    ...
                    <input type="submit" name="register" class="btn btn-light text-danger" value="SignUp">
                    </div>
